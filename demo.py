...
def main():
    ...
    test_model_path = '/data/cb_nlu_finserv_cross_entropy_loss_label_smoothing'
    ...
    df_te.to_json('/data/cb_nlu_results/finserv/te_preds_xentroy_smoothing.json', orient='records', lines=True)
